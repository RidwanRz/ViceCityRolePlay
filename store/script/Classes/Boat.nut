class CBoat extends CContext
{
	...
	function Show()
	{
		...
		this.Membox.AddItem( "Reefer" );
		this.Membox.AddItem( "Tropic" );
		this.Membox.AddItem( "Dinghy" );
		this.Membox.AddItem( "Marquis" );
		this.Membox.AddItem( "Cuban Jetmax" );
		this.Membox.AddItem( "Speeder" );
		this.Membox.AddItem( "Squalo" );
		this.Membox.AddItem( "Skimmer" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			...
			//	Item.SetTexture( "faggio.jpg" );
				...
				this.SetItemPriceText( "Reefer", 600000 );
				
				this.Select = "Reefer:600000";
				break;

				case "Tropic":
			//	Item.SetTexture( "freeway.jpg" );

				this.SetItemPriceText( "Tropic", 720000 );
				
				this.Select = "Tropic:720000";
				break;

				case "Angel":
			//	Item.SetTexture( "angel.jpg" );

				this.SetItemPriceText( "Dinghy", 750000 );
				
				this.Select = "Dinghy:750000";
				break;

				case "Marquis":
			//	Item.SetTexture( "sanchez.jpg" );

				this.SetItemPriceText( "Marquis", 850000 );
				
				this.Select = "Marquis:850000";
				break;

				case "Cuban Jetmax":
			//	Item.SetTexture( "pcj600.jpg" );

				this.SetItemPriceText( "Cuban Jetmax", 870000 );
				
				this.Select = "Cuban Jetmax:740000";
				break;
				
				case "Speeder":
				//Item.SetTexture( "pcj600.jpg" );

				this.SetItemPriceText( "Speeder", 920000 );
				
				this.Select = "Speeder:920000";
				break;

				case "Squalo":
				//Item.SetTexture( "pcj600.jpg" );

				this.SetItemPriceText( "Squalo", 1200000 );
				
				this.Select = "Squalo:1200000";
				break;

				case "Skimmer":
				//Item.SetTexture( "pcj600.jpg" );

				this.SetItemPriceText( "Skimmer", 2000000 );
				
				this.Select = "Skimmer:2000000";
				break;
