class CPoliceDutySS extends CContext
{
	Titlebar = null;
	Titletext = null;
	...
	function Show( type )
	{
        ...
        switch( type )
        {
            ...
            this.Slot1.SetTexture( "LawE/160.jpg" );
            ...
            this.Slot1.SetTexture( "LawE/1.jpg" );
            this.Slot2.SetTexture( "LawE/120.jpg" );
            this.Slot3.SetTexture( "LawE/166.jpg" );
            this.Slot4.SetTexture( "LawE/0.png" );

            this.Slot1.AddFlags( GUI_FLAG_VISIBLE );
            this.Slot2.AddFlags( GUI_FLAG_VISIBLE );
            this.Slot3.AddFlags( GUI_FLAG_VISIBLE );
            this.Slot4.AddFlags( GUI_FLAG_VISIBLE );
            break;

            case "swat":
            this.Titletext.Text = "SWAT Duty";

            this.Slot1.SetTexture( "LawE/2.jpg" );

            this.Slot1.AddFlags( GUI_FLAG_VISIBLE );
            break;

            case "fbi":
            this.Titletext.Text = "FBI Duty";

            this.Slot1.SetTexture( "LawE/3.jpg" );
            this.Slot2.SetTexture( "LawE/0.png" );
	...
	function onElementRelease( element, x, y )
	{
		switch( element )
		{
			...
			case this.Closetext:
			this.Hide();
            Handler.Handlers.PoliceDuty.Show();
			break;
