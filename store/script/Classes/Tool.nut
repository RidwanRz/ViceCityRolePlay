class CTool extends CContext
{
	...
	function Load()
	{
		...
		this.Titletext.Text = "Tools Shop";
	...
	function Show()
	{
		...
		this.Membox.AddItem( "Screwdriver" );
		this.Membox.AddItem( "Knife" );
		this.Membox.AddItem( "Baseball bat" );
		this.Membox.AddItem( "Hammer" );
		this.Membox.AddItem( "Meat Cleaver" );
		this.Membox.AddItem( "Katana" );
		this.Membox.AddItem( "Chainsaw" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			switch( listbox )
			{
				...
				this.SetItemPriceText( "Screwdriver", 10 );
				
				this.Select = "Screwdriver:10:1";
				break;

				case "Knife":
				Item.SetTexture( "Weapon_5.png" );

				this.SetItemPriceText( "Knife", 20 );
				
				this.Select = "knif:20:1";
				break;

				case "Baseball bat":
				Item.SetTexture( "Weapon_6.png" );

				this.SetItemPriceText( "Baseball bat", 40 );
				
				this.Select = "bat:40:1";
				break;

				case "Hammer":
				Item.SetTexture( "Weapon_7.png" );

				this.SetItemPriceText( "Hammer", 50 );
				
				this.Select = "hamm:50:1";
				break;

				case "Meat Cleaver":
				Item.SetTexture( "Weapon_8.png" );

				this.SetItemPriceText( "Meat Cleaver", 60 );
				
				this.Select = "meat:60:1";
				break;

				case "Katana":
				Item.SetTexture( "Weapon_10.png" );

				this.SetItemPriceText( "Katana", 500 );
				
				this.Select = "katana:500:1";
				break;

				case "Chainsaw":
				Item.SetTexture( "Weapon_11.png" );

				this.SetItemPriceText( "Chainsaw", 1000 );
				
				this.Select = "chain:1000:1";
				break;
			}
