class CFun extends CContext
{
	...
	function Show()
	{
		...
		this.Membox.AddItem( "Lounge" );
		this.Membox.AddItem( "Chair" );
		this.Membox.AddItem( "Modern Table" );
		this.Membox.AddItem( "Bed A" );
		this.Membox.AddItem( "Chair A" );
		this.Membox.AddItem( "Couch A" );
		this.Membox.AddItem( "Bed B" );
		this.Membox.AddItem( "Couch B" );
		this.Membox.AddItem( "Desk" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			switch( listbox )
			{
				...
				this.SetItemPriceText( "Lounge", 200 );
				...
				this.SetItemPriceText( "Chair", 200 );
				...
				this.SetItemPriceText( "Modern Table", 750 );
				...
				this.SetItemPriceText( "Bed A", 1500 );
				
				this.Select = "101:1500";
				break;

				case "Chair A":
				Item.SetTexture( "pcj600.jpg" );

				this.SetItemPriceText( "chaira.png", 1500 );
				
				this.Select = "104:1500";
				break;

				case "Couch A":
				Item.SetTexture( "coucha.png" );

				this.SetItemPriceText( "Couch A", 3500 );
				
				this.Select = "105:3500";
				break;

				case "Bed B":
				Item.SetTexture( "bedb.png" );

				this.SetItemPriceText( "Bed B", 4000 );
				
				this.Select = "102:4000";
				break;

				case "Couch B":
				Item.SetTexture( "crouchb.png" );

				this.SetItemPriceText( "Couch B", 5700 );
				
				this.Select = "106:5700";
				break;

				case "Desk":
				Item.SetTexture( "desk.png" );

				this.SetItemPriceText( "Desk", 6000 );
				
				this.Select = "108:6000";
				break;
