class CItems extends CContext
{
	...
	function Show()
	{
		...
		this.Membox.AddItem( "GPS Level 1" );
		this.Membox.AddItem( "GPS Level 2" );
		this.Membox.AddItem( "GPS Level 3" );
		this.Membox.AddItem( "Kit_Kat" );
		this.Membox.AddItem( "Medic Kit" );
		this.Membox.AddItem( "Lockpick" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			...
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "GPS Level 1", 20000 );
				...
				case "GPS Level 2":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "GPS Level 2", 50000 );
				...
				case "GPS Level 3":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "GPS Level 3", 100000 );
				
				this.Select = "7:100000";
				break;

				case "Kit_Kat":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Kool_Kat", 50 );
				...
				case "Medic Kit":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Medic Kit", 1000 );
				
				this.Select = "8:1000";
				break;

				case "Lockpick":
				this.SetItemPriceText( "Lockpick", 5000 );
