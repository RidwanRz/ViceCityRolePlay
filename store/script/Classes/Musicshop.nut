class CMusic extends CContext
{
	...
	function Load()
	{
		...
		this.Titletext.Text = "Music Shop";
		...
		this.Play = GUICanvas();
		this.Play.Pos = VectorScreen( rel.X * 0.4582723279648609, rel.Y * 0.5924479166666667 );
		this.Play.Size = VectorScreen( rel.X * 0.1939970717423133, rel.Y * 0.0455729166666667 );
		this.Play.Colour = Colour( 66, 70, 71, 255 );
		this.Play.AddFlags( GUI_FLAG_MOUSECTRL );

		this.Playtext = GUILabel();
		this.Play.AddChild( Playtext );
		this.Playtext.TextColour = Colour( 255, 255, 255 );
		this.Playtext.Pos =  VectorScreen( rel.X * 0.1976573938506589, rel.Y * 0.0065104166666667 );		
		this.Playtext.TextAlignment = GUI_ALIGN_CENTER;
		this.Playtext.FontFlags = GUI_FFLAG_BOLD;		
		this.Playtext.Text = "Play";
		this.Playtext.FontSize = ( rel.X * 0.0087847730600293 );
		this.Playtext.AddFlags( GUI_FLAG_MOUSECTRL );
		this.centerinchild( this.Play, this.Playtext );
		...
		this.ErrorText.Pos =  VectorScreen( rel.X * 0.1976573938506589, rel.Y * 0.546875 );		
		...
		this.Play.RemoveFlags( GUI_FLAG_VISIBLE | GUI_FLAG_KBCTRL );
		this.Playtext.RemoveFlags( GUI_FLAG_VISIBLE | GUI_FLAG_KBCTRL );
	}
	...
	function Show()
	{
		...
		this.Play.AddFlags( GUI_FLAG_VISIBLE | GUI_FLAG_KBCTRL );
		this.Playtext.AddFlags( GUI_FLAG_VISIBLE | GUI_FLAG_KBCTRL );
		...
		this.Membox.AddItem( "Insult #1" );
		this.Membox.AddItem( "Insult #2" );
		this.Membox.AddItem( "Insult #3" );
		this.Membox.AddItem( "MVP #1" );
		this.Membox.AddItem( "MVP #2" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			...
			{
				case "Insult #1":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Music Kit: Tempany Insult", 1500 );
				...
				case "Insult #2":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Music Kit: Man Slaps Paki Girl In Room", 1500 );
				...
				case "Insult #3":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Music Kit: apEX Insult", 1500 );
				...
				case "MVP #1":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Music Kit: San Andreas Mission Passed Theme", 2000 );
				...
				case "MVP #2":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Music Kit: EZ4ENCE", 2000 );
	...
	function onElementHoverOver( element )
	{
		switch( element )
		{
			...
			this.Play.Colour = Colour( 255, 255, 255, 255 );
			this.Playtext.TextColour = Colour( 66, 70, 71, 255 );
			break;
		}
	}
	...
	function onElementHoverOut( element )
	{
		switch( element )
		{
			...
			this.Play.Colour = Colour( 66, 70, 71, 255 );
			this.Playtext.TextColour = Colour( 255, 255, 255, 255 );
			break;		
		}
	}
	...
	function onElementRelease( element, x, y )
	{
		switch( element )
		{
			...
			else 
			{
				...
				message.WriteInt( 6400 );
				message.WriteString( getSound );
				Server.SendData( message );
			}
			break;
		}
