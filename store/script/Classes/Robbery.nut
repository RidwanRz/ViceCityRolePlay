class CRobbery extends CContext
{
	Background = null;
	...
	function Show()
	{
		...
		getHash = Timer.Create( this, function() 
		{
			...
			if( cooldown < 15 ) this.Title.Text = "Cracking safe...";
			if( cooldown < 5 ) this.Title.Text = "Grabbing cash...";
