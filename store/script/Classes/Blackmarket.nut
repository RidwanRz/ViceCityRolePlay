class CBM extends CContext
{
	...
	function Load()
	{
		...
		this.Titletext.Text = "Black Market";
	...
	function Show()
	{
		...
		this.Membox.AddItem( "M4" );
		this.Membox.AddItem( "M60" );
		this.Membox.AddItem( "Bomb" );
		this.Membox.AddItem( "Molotov" );
		this.Membox.AddItem( "Grenade" );
		this.Membox.AddItem( "Rocket Laucher" );
		this.Membox.AddItem( "Bulldog Shotgun" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			...
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "M4", 200000 );
				
				this.Select = "m4:10000:6";
				break;
				
				case "M60":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "M60", 500000 );
				
				this.Select = "m60:50000:7";
				break;

				case "Molotov":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Molotov", 620000 );
				
				this.Select = "molotov:30000:2";
				break;

				case "Rocket Laucher":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Rocket Laucher", 1200000 );
				
				this.Select = "rpg:100000:7";
				break;		

				case "Grenade":
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Grenade", 620000 );
				
				this.Select = "grenade:20000:2";
				break;		
			...
			//	Item.SetTexture( "Weapon_2.png" );
				this.SetItemPriceText( "Bulldog Shotgun", 40000 );
				
				this.Select = "bulldog:40000:4";
				break;
			}
