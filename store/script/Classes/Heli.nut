class CHeli extends CContext
{
	...
	function Show()
	{
		...
		this.Membox.AddItem( "Sparrow" );
		this.Membox.AddItem( "Maverick" );		
		this.Membox.AddItem( "VCN Maverick" );
	...
	function onListboxSelect( element, listbox )
	{
		if( element == this.Membox )
		{
			...
			{
				case "Sparrow":
				Item.SetTexture( "Vehicle_199.jpg" );

				this.SetItemPriceText( "Sparrow", 400000 );
				
				this.Select = "Sparrow:400000";
				break;

				case "Maverick":
				Item.SetTexture( "Vehicle_217.jpg" );

				this.SetItemPriceText( "Maverick", 800000 );
				
				this.Select = "Maverick:800000";
				break;
				
				case "VCN Maverick":
				//Item.SetTexture( "Vehicle_217.jpg" );

				this.SetItemPriceText( "VCN Maverick", 600000 );
				
				this.Select = "VCN Maverick:600000";
				break;
			}
